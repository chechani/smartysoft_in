...
const PrivacyPolicy = () => {
  return (
    ...
    <WhatsAppButton/>
    <Card sx={{p:3}}>
      <Typography variant='h3'sx={{fontFamily:"lato",mb:2,fontWeight:"bold"}}>Privacy Policy</Typography>
      <Typography sx={{fontFamily:"lato",fontSize:"20px"}}>
      ...
      <Box sx={{mt:3}}>
      <Typography variant='h4' sx={{fontFamily:"lato",mb:2}}>Information We Collect</Typography>
      <Typography sx={{fontFamily:"lato",fontSize:"20px"}}>
      ...
      <Typography sx={{fontFamily:"lato", fontSize:"30px",mt:2,mb:1}}>How We Use Your Information</Typography>
      ...
      <Typography sx={{fontFamily:"lato",fontSize:"30px",mt:2,mb:1}}>How We Share Your Information</Typography>
      <Typography sx={{fontFamily:"lato",fontSize:"20px"}}>
      ...
      <Typography sx={{fontFamily:"lato",fontSize:"30px",mt:2,mb:1}}>Data Retention and Security</Typography>
      <Typography sx={{fontFamily:"lato",fontSize:"20px"}}>
      ...
      <Typography sx={{fontFamily:"lato",fontSize:"30px",mt:2,mb:1}}>Your Rights</Typography>
      <Typography sx={{fontFamily:"lato",fontSize:"20px"}}>
  ...
  <Typography sx={{fontFamily:"lato",fontSize:"20px"}}>Updates to This Privacy Policy</Typography>
  <Typography sx={{fontFamily:"lato",fontSize:"20px"}}>
  ...
  <Typography sx={{fontFamily:"lato",fontSize:"30px",fontWeight:"bold",mt:2,pb:2}}>Contact Us</Typography>
  <Typography sx={{fontFamily:"lato",fontSize:"20px"}}>
    If you have any questions or concerns about our Privacy Policy, please
    get in touch with us at:
  </Typography>
  <address style={{fontFamily:"lato",fontSize:"15px",fontWeight:"bold"}}>
  ...
  <Typography sx={{fontFamily:"lato",fontSize:"20px"}}>Thank you for using our services.</Typography>
  </Card>
</Box>
);
};
