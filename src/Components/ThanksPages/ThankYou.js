...
const ThankYou = ()=>{
    ...
    return(
        ...
        />
        <Typography  sx={{mt:5,fontSize:"42px",fontWeight:"bold",color:"green"}}>Thank You for Downloading Excel to Tally Integration</Typography>
        ...
        <Typography  sx={{mt:2,fontSize:"22px"}}>Thank you again for downloading our Excel to Tally integration solution. We are excited to hear how it has helped your business.</Typography>
        </Box>
        </Card>
