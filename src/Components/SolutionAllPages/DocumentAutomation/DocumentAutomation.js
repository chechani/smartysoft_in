...
function DocumentAutomationManagement() {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://smartysoftware.in/api/method/professional.web.get_solution_landing?docname=document%20automation%20and%20management"
        );
...
export default DocumentAutomationManagement;
