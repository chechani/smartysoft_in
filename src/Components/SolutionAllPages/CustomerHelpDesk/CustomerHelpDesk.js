...
import CustomerHelpDeskCard from './CustomerHelpDeskCard';
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://smartysoftware.in/api/method/professional.web.get_solution_landing?docname=customer%20help%20desk"
        );
