            ...
            <Grid container spacing={5} sx={{ mb: 5}}>
              ...
              <Grid item xs={12} sm={6} md={4}>
                <Card sx={{ p: 2 }}>
                  ...
                  <Typography sx={{ fontSize: "18px", fontFamily: "lato", mt: 2 }}>Nextcloud is a suite of client-server software for creating and using file hosting services. Nextcloud provides functionality similar to Dropbox, Office 365 </Typography>
